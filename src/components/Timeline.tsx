  ...
  return (
    <div className="my-12 flex flex-col pr-[140px] md:pr-0 md:flex-row w-[95vw] lg:w-[80vw] items-center justify-center">
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="relative">
            <Hepta />
            <h1 className="absolute -top-2 md:top-10 ml-12 md:ml-0 md:-left-16 w-[170px] mt-4 text-white mb-4 md:mb-0 md:text-xl lg:text-3xl mx-1 text-center md:text-center">Event ends<br/>27th 4pm</h1>
          </div>
